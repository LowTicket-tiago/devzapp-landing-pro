...
export function FaqSection() {
  ...
  return <section className="py-20 bg-darker-bg">
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-4xl mx-auto space-y-4">
          {faqs.map((faq, index) => <Card key={index} className="bg-card border-primary/20 hover:border-primary/40 transition-colors">
              <Collapsible open={openItems.includes(index)} onOpenChange={() => toggleItem(index)}>
                <CollapsibleTrigger className="w-full p-6 text-left">
                  <div className="flex items-center justify-between">
                    ...
                    <ChevronDown className={`w-5 h-5 text-primary transition-transform ${openItems.includes(index) ? 'rotate-180' : ''}`} />
                  </div>
                </CollapsibleTrigger>
                <CollapsibleContent>
        ...
        <div className="text-center mt-12">
          <Card className="p-8 bg-gradient-neon border-primary/20 max-w-2xl mx-auto">
            ...
            <p className="text-gray-text">
              ...
              <a href="mailto:suporte@devzapp.com.br" className="text-primary font-semibold hover:underline">contato@tiagosilva.com.br</a>
            </p>
          </Card>
        </div>
      </div>
